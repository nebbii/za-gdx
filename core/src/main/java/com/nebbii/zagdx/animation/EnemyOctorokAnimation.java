...
import com.nebbii.zagdx.EnemyOctorok;
import com.nebbii.zagdx.ImageLoader.EnemyOctorokAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames, but 6 sprite files exist on disk; using the 6 real frames
public class EnemyOctorokAnimation extends GameAnimation {
    private final EnemyOctorok enemy;
    ...
    public EnemyOctorokAnimation(EnemyOctorok enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyOctorokAnimation(EnemyOctorokAnimationGroup.WALK);
