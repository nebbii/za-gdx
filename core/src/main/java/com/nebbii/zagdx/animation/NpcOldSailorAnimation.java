...
import com.nebbii.zagdx.ImageLoader.NpcOldSailorAnimationGroup;
import com.nebbii.zagdx.NpcOldSailor;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4/4/3 frames per group, but 4/4/4 sprite files exist on disk; using
// the real counts.
public class NpcOldSailorAnimation extends GameAnimation {
    private final NpcOldSailor npc;
    ...
    public NpcOldSailorAnimation(NpcOldSailor npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcOldSailorAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcOldSailorAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcOldSailorAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcOldSailorAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcOldSailorAnimation(group);
