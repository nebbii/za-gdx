...
import com.nebbii.zagdx.ImageLoader.NpcPurpleStallOwnerAnimationGroup;
import com.nebbii.zagdx.NpcPurpleStallOwner;
import com.nebbii.zagdx.World;

public class NpcPurpleStallOwnerAnimation extends GameAnimation {
    private final NpcPurpleStallOwner npc;
    ...
    public NpcPurpleStallOwnerAnimation(NpcPurpleStallOwner npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcPurpleStallOwnerAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcPurpleStallOwnerAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcPurpleStallOwnerAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcPurpleStallOwnerAnimation(group);
