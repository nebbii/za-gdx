...
import com.nebbii.zagdx.ImageLoader.NpcSkaterDudeAnimationGroup;
import com.nebbii.zagdx.NpcSkaterDude;
import com.nebbii.zagdx.World;

public class NpcSkaterDudeAnimation extends GameAnimation {
    private final NpcSkaterDude npc;
    ...
    public NpcSkaterDudeAnimation(NpcSkaterDude npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcSkaterDudeAnimation(NpcSkaterDudeAnimationGroup.IDLE);
