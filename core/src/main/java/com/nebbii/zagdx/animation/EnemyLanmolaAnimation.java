...
import com.nebbii.zagdx.EnemyLanmola;
import com.nebbii.zagdx.ImageLoader.EnemyLanmolaAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyLanmolaAnimation extends GameAnimation {
    private final EnemyLanmola enemy;
    ...
    public EnemyLanmolaAnimation(EnemyLanmola enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyLanmola direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyLanmolaAnimation(EnemyLanmolaAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyLanmolaAnimation(EnemyLanmolaAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyLanmolaAnimation(EnemyLanmolaAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyLanmolaAnimation(EnemyLanmolaAnimationGroup.WALKLEFT);
