...
import com.nebbii.zagdx.EnemyPeahat;
import com.nebbii.zagdx.ImageLoader.EnemyPeahatAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyPeahatAnimation extends GameAnimation {
    private final EnemyPeahat enemy;
    ...
    public EnemyPeahatAnimation(EnemyPeahat enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyPeahatAnimation(EnemyPeahatAnimationGroup.WALK);
