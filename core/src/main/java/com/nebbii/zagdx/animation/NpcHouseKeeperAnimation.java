...
import com.nebbii.zagdx.ImageLoader.NpcHouseKeeperAnimationGroup;
import com.nebbii.zagdx.NpcHouseKeeper;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4/5 frames for group0/1, but 3/3 sprite files exist on disk; using the
// real counts.
public class NpcHouseKeeperAnimation extends GameAnimation {
    private final NpcHouseKeeper npc;
    ...
    public NpcHouseKeeperAnimation(NpcHouseKeeper npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcHouseKeeperAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcHouseKeeperAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcHouseKeeperAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcHouseKeeperAnimation(group);
