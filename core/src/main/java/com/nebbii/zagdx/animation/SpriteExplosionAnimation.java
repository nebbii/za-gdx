...
import com.nebbii.zagdx.ImageLoader.SpriteExplosionAnimationGroup;
import com.nebbii.zagdx.SpriteExplosion;
import com.nebbii.zagdx.World;

public class SpriteExplosionAnimation extends GameAnimation {
    private final SpriteExplosion sprite;
    ...
    public SpriteExplosionAnimation(SpriteExplosion sprite) {
        super("idle");
        this.sprite = sprite;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getSpriteExplosionAnimation(SpriteExplosionAnimationGroup.IDLE);
