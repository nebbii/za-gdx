...
import com.nebbii.zagdx.EnemyGibdo;
import com.nebbii.zagdx.ImageLoader.EnemyGibdoAnimationGroup;
...
public class EnemyGibdoAnimation extends GameAnimation {
    private final EnemyGibdo enemy;
    ...
    public EnemyGibdoAnimation(EnemyGibdo enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyGibdo direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyGibdoAnimation(EnemyGibdoAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyGibdoAnimation(EnemyGibdoAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyGibdoAnimation(EnemyGibdoAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyGibdoAnimation(EnemyGibdoAnimationGroup.WALKLEFT);
