...
import com.nebbii.zagdx.EnemyVolta;
import com.nebbii.zagdx.ImageLoader.EnemyVoltaAnimationGroup;
...
public class EnemyVoltaAnimation extends GameAnimation {
    private final EnemyVolta enemy;
    ...
    public EnemyVoltaAnimation(EnemyVolta enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyVolta direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyVoltaAnimation(EnemyVoltaAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyVoltaAnimation(EnemyVoltaAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyVoltaAnimation(EnemyVoltaAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyVoltaAnimation(EnemyVoltaAnimationGroup.WALKLEFT);
