...
import com.nebbii.zagdx.EnemyVapora;
import com.nebbii.zagdx.ImageLoader.EnemyVaporaAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyVaporaAnimation extends GameAnimation {
    private final EnemyVapora enemy;
    ...
    public EnemyVaporaAnimation(EnemyVapora enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyVaporaAnimation(EnemyVaporaAnimationGroup.WALK);
