...
import com.nebbii.zagdx.ImageLoader.NpcSailorAnimationGroup;
import com.nebbii.zagdx.NpcSailor;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4/4/3 frames per group, but 4/4/4 sprite files exist on disk; using
// the real counts.
public class NpcSailorAnimation extends GameAnimation {
    private final NpcSailor npc;
    ...
    public NpcSailorAnimation(NpcSailor npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcSailorAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcSailorAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcSailorAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcSailorAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcSailorAnimation(group);
