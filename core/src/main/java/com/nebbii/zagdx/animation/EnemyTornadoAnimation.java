...
import com.nebbii.zagdx.EnemyTornado;
import com.nebbii.zagdx.ImageLoader.EnemyTornadoAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyTornadoAnimation extends GameAnimation {
    private final EnemyTornado enemy;
    ...
    public EnemyTornadoAnimation(EnemyTornado enemy) {
        super("idle");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getEnemyTornadoAnimation(EnemyTornadoAnimationGroup.IDLE);
