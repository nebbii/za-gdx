...
import com.nebbii.zagdx.EnemyLoccasin;
import com.nebbii.zagdx.ImageLoader.EnemyLoccasinAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 2 frames per direction, but 3 sprite files exist on disk; using the 3 real frames
public class EnemyLoccasinAnimation extends GameAnimation {
    private final EnemyLoccasin enemy;
    ...
    public EnemyLoccasinAnimation(EnemyLoccasin enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyLoccasin direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyLoccasinAnimation(EnemyLoccasinAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyLoccasinAnimation(EnemyLoccasinAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyLoccasinAnimation(EnemyLoccasinAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyLoccasinAnimation(EnemyLoccasinAnimationGroup.WALKLEFT);
