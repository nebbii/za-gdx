...
import com.nebbii.zagdx.EnemyFloorSpikes;
import com.nebbii.zagdx.ImageLoader.EnemyFloorSpikesAnimationGroup;
...
public class EnemyFloorSpikesAnimation extends GameAnimation {
    private final EnemyFloorSpikes enemy;
    ...
    public EnemyFloorSpikesAnimation(EnemyFloorSpikes enemy) {
        super("idle");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getEnemyFloorSpikesAnimation(EnemyFloorSpikesAnimationGroup.IDLE);
