...
import com.nebbii.zagdx.EnemyGolem;
import com.nebbii.zagdx.ImageLoader.EnemyGolemAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 10/12/12/12 frames, but only 6/7/7/7 sprite files exist on disk; using the real counts
public class EnemyGolemAnimation extends GameAnimation {
    private final EnemyGolem enemy;
    ...
    public EnemyGolemAnimation(EnemyGolem enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyGolem direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyGolemAnimation(EnemyGolemAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyGolemAnimation(EnemyGolemAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyGolemAnimation(EnemyGolemAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyGolemAnimation(EnemyGolemAnimationGroup.WALKLEFT);
