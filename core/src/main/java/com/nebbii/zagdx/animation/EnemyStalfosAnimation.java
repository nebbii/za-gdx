...
import com.nebbii.zagdx.EnemyStalfos;
import com.nebbii.zagdx.ImageLoader.EnemyStalfosAnimationGroup;
...
public class EnemyStalfosAnimation extends GameAnimation {
    private final EnemyStalfos enemy;
    ...
    public EnemyStalfosAnimation(EnemyStalfos enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyStalfos direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyStalfosAnimation(EnemyStalfosAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyStalfosAnimation(EnemyStalfosAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyStalfosAnimation(EnemyStalfosAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyStalfosAnimation(EnemyStalfosAnimationGroup.WALKLEFT);
