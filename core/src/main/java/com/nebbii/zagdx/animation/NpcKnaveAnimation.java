...
import com.nebbii.zagdx.ImageLoader.NpcKnaveAnimationGroup;
import com.nebbii.zagdx.NpcKnave;
import com.nebbii.zagdx.World;

public class NpcKnaveAnimation extends GameAnimation {
    private final NpcKnave npc;
    ...
    public NpcKnaveAnimation(NpcKnave npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcKnaveAnimation(NpcKnaveAnimationGroup.IDLE);
