...
import com.nebbii.zagdx.ImageLoader.NpcHoodedWomanAnimationGroup;
import com.nebbii.zagdx.NpcHoodedWoman;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames, but only 3 sprite files exist on disk; using the real count
public class NpcHoodedWomanAnimation extends GameAnimation {
    private final NpcHoodedWoman npc;
    ...
    public NpcHoodedWomanAnimation(NpcHoodedWoman npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcHoodedWomanAnimation(NpcHoodedWomanAnimationGroup.IDLE);
