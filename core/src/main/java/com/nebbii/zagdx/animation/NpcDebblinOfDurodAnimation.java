...
import com.nebbii.zagdx.ImageLoader.NpcDebblinOfDurodAnimationGroup;
import com.nebbii.zagdx.NpcDebblinOfDurod;
import com.nebbii.zagdx.World;

public class NpcDebblinOfDurodAnimation extends GameAnimation {
    private final NpcDebblinOfDurod npc;
    ...
    public NpcDebblinOfDurodAnimation(NpcDebblinOfDurod npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcDebblinOfDurodAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcDebblinOfDurodAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcDebblinOfDurodAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcDebblinOfDurodAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcDebblinOfDurodAnimation(group);
