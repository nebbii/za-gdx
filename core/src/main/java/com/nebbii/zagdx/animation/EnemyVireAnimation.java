...
import com.nebbii.zagdx.EnemyVire;
import com.nebbii.zagdx.ImageLoader.EnemyVireAnimationGroup;
...
public class EnemyVireAnimation extends GameAnimation {
    private final EnemyVire enemy;
    ...
    public EnemyVireAnimation(EnemyVire enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyVire direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyVireAnimation(EnemyVireAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyVireAnimation(EnemyVireAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyVireAnimation(EnemyVireAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyVireAnimation(EnemyVireAnimationGroup.WALKLEFT);
