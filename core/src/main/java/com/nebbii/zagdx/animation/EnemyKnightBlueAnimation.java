...
import com.nebbii.zagdx.EnemyKnightBlue;
import com.nebbii.zagdx.ImageLoader.EnemyKnightBlueAnimationGroup;
...
public class EnemyKnightBlueAnimation extends GameAnimation {
    private final EnemyKnightBlue enemy;
    ...
    public EnemyKnightBlueAnimation(EnemyKnightBlue enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyKnightBlue direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyKnightBlueAnimation(EnemyKnightBlueAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyKnightBlueAnimation(EnemyKnightBlueAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyKnightBlueAnimation(EnemyKnightBlueAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyKnightBlueAnimation(EnemyKnightBlueAnimationGroup.WALKLEFT);
