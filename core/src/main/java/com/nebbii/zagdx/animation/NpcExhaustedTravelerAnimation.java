...
import com.nebbii.zagdx.ImageLoader.NpcExhaustedTravelerAnimationGroup;
import com.nebbii.zagdx.NpcExhaustedTraveler;
import com.nebbii.zagdx.World;

public class NpcExhaustedTravelerAnimation extends GameAnimation {
    private final NpcExhaustedTraveler npc;
    ...
    public NpcExhaustedTravelerAnimation(NpcExhaustedTraveler npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcExhaustedTravelerAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcExhaustedTravelerAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcExhaustedTravelerAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcExhaustedTravelerAnimation(group);
