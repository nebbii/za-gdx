...
import com.nebbii.zagdx.ImageLoader.NpcToobarAnimationGroup;
import com.nebbii.zagdx.NpcToobar;
import com.nebbii.zagdx.World;

public class NpcToobarAnimation extends GameAnimation {
    private final NpcToobar npc;
    ...
    public NpcToobarAnimation(NpcToobar npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcToobarAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcToobarAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcToobarAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcToobarAnimation(group);
