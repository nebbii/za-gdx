...
import com.nebbii.zagdx.EnemyKnightGreen;
import com.nebbii.zagdx.ImageLoader.EnemyKnightGreenAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 6 frames per direction, but only 4 sprite files exist on disk; using the 4 real frames
public class EnemyKnightGreenAnimation extends GameAnimation {
    private final EnemyKnightGreen enemy;
    ...
    public EnemyKnightGreenAnimation(EnemyKnightGreen enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyKnightGreen direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyKnightGreenAnimation(EnemyKnightGreenAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyKnightGreenAnimation(EnemyKnightGreenAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyKnightGreenAnimation(EnemyKnightGreenAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyKnightGreenAnimation(EnemyKnightGreenAnimationGroup.WALKLEFT);
