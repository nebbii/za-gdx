...
import com.nebbii.zagdx.EnemyRomraven;
import com.nebbii.zagdx.ImageLoader.EnemyRomravenAnimationGroup;
...
public class EnemyRomravenAnimation extends GameAnimation {
    private final EnemyRomraven enemy;
    ...
    public EnemyRomravenAnimation(EnemyRomraven enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyRomraven direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyRomravenAnimation(EnemyRomravenAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyRomravenAnimation(EnemyRomravenAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyRomravenAnimation(EnemyRomravenAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyRomravenAnimation(EnemyRomravenAnimationGroup.WALKLEFT);
