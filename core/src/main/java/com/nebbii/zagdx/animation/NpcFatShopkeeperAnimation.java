...
import com.nebbii.zagdx.ImageLoader.NpcFatShopkeeperAnimationGroup;
import com.nebbii.zagdx.NpcFatShopkeeper;
import com.nebbii.zagdx.World;

public class NpcFatShopkeeperAnimation extends GameAnimation {
    private final NpcFatShopkeeper npc;
    ...
    public NpcFatShopkeeperAnimation(NpcFatShopkeeper npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcFatShopkeeperAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcFatShopkeeperAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcFatShopkeeperAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcFatShopkeeperAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcFatShopkeeperAnimation(group);
