...
import com.nebbii.zagdx.ImageLoader.NpcLotharAnimationGroup;
import com.nebbii.zagdx.NpcLothar;
import com.nebbii.zagdx.World;

public class NpcLotharAnimation extends GameAnimation {
    private final NpcLothar npc;
    ...
    public NpcLotharAnimation(NpcLothar npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcLotharAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcLotharAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcLotharAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcLotharAnimation(group);
