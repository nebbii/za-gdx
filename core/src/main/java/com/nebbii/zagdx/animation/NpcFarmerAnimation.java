...
import com.nebbii.zagdx.ImageLoader.NpcFarmerAnimationGroup;
import com.nebbii.zagdx.NpcFarmer;
import com.nebbii.zagdx.World;

public class NpcFarmerAnimation extends GameAnimation {
    private final NpcFarmer npc;
    ...
    public NpcFarmerAnimation(NpcFarmer npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        ...
        Texture[] textures = World.images.getNpcFarmerAnimation(NpcFarmerAnimationGroup.IDLE);
