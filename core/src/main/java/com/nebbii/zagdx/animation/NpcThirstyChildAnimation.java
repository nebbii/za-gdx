...
import com.nebbii.zagdx.ImageLoader.NpcThirstyChildAnimationGroup;
import com.nebbii.zagdx.NpcThirstyChild;
import com.nebbii.zagdx.World;

public class NpcThirstyChildAnimation extends GameAnimation {
    private final NpcThirstyChild npc;
    ...
    public NpcThirstyChildAnimation(NpcThirstyChild npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcThirstyChildAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcThirstyChildAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcThirstyChildAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcThirstyChildAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcThirstyChildAnimation(group);
