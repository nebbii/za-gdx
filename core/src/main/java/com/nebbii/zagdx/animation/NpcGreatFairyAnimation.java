...
import com.nebbii.zagdx.ImageLoader.NpcGreatFairyAnimationGroup;
import com.nebbii.zagdx.NpcGreatFairy;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames, but only 3 sprite files exist on disk; using the real count
public class NpcGreatFairyAnimation extends GameAnimation {
    private final NpcGreatFairy npc;
    ...
    public NpcGreatFairyAnimation(NpcGreatFairy npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcGreatFairyAnimation(NpcGreatFairyAnimationGroup.IDLE);
