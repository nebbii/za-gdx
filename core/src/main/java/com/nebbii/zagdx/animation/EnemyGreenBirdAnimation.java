...
import com.nebbii.zagdx.EnemyGreenBird;
import com.nebbii.zagdx.ImageLoader.EnemyGreenBirdAnimationGroup;
...
public class EnemyGreenBirdAnimation extends GameAnimation {
    private final EnemyGreenBird enemy;
    ...
    public EnemyGreenBirdAnimation(EnemyGreenBird enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyGreenBird direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyGreenBirdAnimation(EnemyGreenBirdAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyGreenBirdAnimation(EnemyGreenBirdAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyGreenBirdAnimation(EnemyGreenBirdAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyGreenBirdAnimation(EnemyGreenBirdAnimationGroup.WALKLEFT);
