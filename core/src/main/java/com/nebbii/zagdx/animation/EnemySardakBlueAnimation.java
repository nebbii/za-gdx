...
import com.nebbii.zagdx.EnemySardakBlue;
import com.nebbii.zagdx.ImageLoader.EnemySardakBlueAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemySardakBlueAnimation extends GameAnimation {
    private final EnemySardakBlue enemy;
    ...
    public EnemySardakBlueAnimation(EnemySardakBlue enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled sardak blue direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemySardakBlueAnimation(EnemySardakBlueAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemySardakBlueAnimation(EnemySardakBlueAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemySardakBlueAnimation(EnemySardakBlueAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemySardakBlueAnimation(EnemySardakBlueAnimationGroup.WALKLEFT);
