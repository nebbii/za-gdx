...
import com.nebbii.zagdx.EnemySwampZolaGreen;
import com.nebbii.zagdx.ImageLoader.EnemySwampZolaGreenAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames per direction, but only 5 sprite files exist on disk; using the 5 real frames
public class EnemySwampZolaGreenAnimation extends GameAnimation {
    private final EnemySwampZolaGreen enemy;
    ...
    public EnemySwampZolaGreenAnimation(EnemySwampZolaGreen enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemySwampZolaGreen direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemySwampZolaGreenAnimation(EnemySwampZolaGreenAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemySwampZolaGreenAnimation(EnemySwampZolaGreenAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemySwampZolaGreenAnimation(EnemySwampZolaGreenAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemySwampZolaGreenAnimation(EnemySwampZolaGreenAnimationGroup.WALKLEFT);
