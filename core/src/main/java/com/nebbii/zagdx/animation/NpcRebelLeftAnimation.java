...
import com.nebbii.zagdx.ImageLoader.NpcRebelLeftAnimationGroup;
import com.nebbii.zagdx.NpcRebelLeft;
import com.nebbii.zagdx.World;

public class NpcRebelLeftAnimation extends GameAnimation {
    private final NpcRebelLeft npc;
    ...
    public NpcRebelLeftAnimation(NpcRebelLeft npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcRebelLeftAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcRebelLeftAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcRebelLeftAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcRebelLeftAnimation(group);
