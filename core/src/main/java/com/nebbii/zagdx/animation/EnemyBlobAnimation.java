...
import com.nebbii.zagdx.EnemyBlob;
import com.nebbii.zagdx.ImageLoader.EnemyBlobAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyBlobAnimation extends GameAnimation {
    private final EnemyBlob enemy;
    ...
    public EnemyBlobAnimation(EnemyBlob enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyBlobAnimation(EnemyBlobAnimationGroup.WALK);
