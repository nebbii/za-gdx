...
import com.nebbii.zagdx.ImageLoader.NpcQuietFishermanAnimationGroup;
import com.nebbii.zagdx.NpcQuietFisherman;
import com.nebbii.zagdx.World;

public class NpcQuietFishermanAnimation extends GameAnimation {
    private final NpcQuietFisherman npc;
    ...
    public NpcQuietFishermanAnimation(NpcQuietFisherman npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcQuietFishermanAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcQuietFishermanAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcQuietFishermanAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcQuietFishermanAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcQuietFishermanAnimation(group);
