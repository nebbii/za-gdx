...
import com.nebbii.zagdx.ImageLoader.NpcMysticAnimationGroup;
import com.nebbii.zagdx.NpcMystic;
...
public class NpcMysticAnimation extends GameAnimation {
    private final NpcMystic npc;
    ...
    public NpcMysticAnimation(NpcMystic npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcMystic direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcMysticAnimation(NpcMysticAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcMysticAnimation(NpcMysticAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcMysticAnimation(NpcMysticAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcMysticAnimation(NpcMysticAnimationGroup.IDLELEFT);
