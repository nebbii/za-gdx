...
import com.nebbii.zagdx.ImageLoader.NpcEtheraAnimationGroup;
import com.nebbii.zagdx.NpcEthera;
...
public class NpcEtheraAnimation extends GameAnimation {
    private final NpcEthera npc;
    ...
    public NpcEtheraAnimation(NpcEthera npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcEthera direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcEtheraAnimation(NpcEtheraAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcEtheraAnimation(NpcEtheraAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcEtheraAnimation(NpcEtheraAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcEtheraAnimation(NpcEtheraAnimationGroup.IDLELEFT);
