...
import com.nebbii.zagdx.ImageLoader.NpcSquireGripAnimationGroup;
import com.nebbii.zagdx.NpcSquireGrip;
import com.nebbii.zagdx.World;

public class NpcSquireGripAnimation extends GameAnimation {
    private final NpcSquireGrip npc;
    ...
    public NpcSquireGripAnimation(NpcSquireGrip npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures =
            World.images.getNpcSquireGripAnimation(NpcSquireGripAnimationGroup.IDLE);
