...
import com.nebbii.zagdx.ImageLoader.NpcFortuneTellerAnimationGroup;
import com.nebbii.zagdx.NpcFortuneTeller;
import com.nebbii.zagdx.World;

public class NpcFortuneTellerAnimation extends GameAnimation {
    private final NpcFortuneTeller npc;
    ...
    public NpcFortuneTellerAnimation(NpcFortuneTeller npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcFortuneTellerAnimation(NpcFortuneTellerAnimationGroup.IDLE);
