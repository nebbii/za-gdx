...
import com.nebbii.zagdx.EnemyWizzrobe;
import com.nebbii.zagdx.ImageLoader.EnemyWizzrobeAnimationGroup;
...
public class EnemyWizzrobeAnimation extends GameAnimation {
    private final EnemyWizzrobe enemy;
    ...
    public EnemyWizzrobeAnimation(EnemyWizzrobe enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyWizzrobe direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyWizzrobeAnimation(EnemyWizzrobeAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyWizzrobeAnimation(EnemyWizzrobeAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyWizzrobeAnimation(EnemyWizzrobeAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyWizzrobeAnimation(EnemyWizzrobeAnimationGroup.WALKLEFT);
