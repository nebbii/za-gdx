...
import com.nebbii.zagdx.ImageLoader.NpcNimoneeAnimationGroup;
import com.nebbii.zagdx.NpcNimonee;
import com.nebbii.zagdx.World;

public class NpcNimoneeAnimation extends GameAnimation {
    private final NpcNimonee npc;
    ...
    public NpcNimoneeAnimation(NpcNimonee npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcNimoneeAnimation(NpcNimoneeAnimationGroup.IDLE);
