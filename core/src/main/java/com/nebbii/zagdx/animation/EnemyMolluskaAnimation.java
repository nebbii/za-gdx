...
import com.nebbii.zagdx.EnemyMolluska;
import com.nebbii.zagdx.ImageLoader.EnemyMolluskaAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyMolluskaAnimation extends GameAnimation {
    private final EnemyMolluska enemy;
    ...
    public EnemyMolluskaAnimation(EnemyMolluska enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyMolluskaAnimation(EnemyMolluskaAnimationGroup.WALK);
