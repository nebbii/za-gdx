...
import com.nebbii.zagdx.EnemyAgwanda;
import com.nebbii.zagdx.ImageLoader.EnemyAgwandaAnimationGroup;
...
public class EnemyAgwandaAnimation extends GameAnimation {
    private final EnemyAgwanda enemy;
    ...
    public EnemyAgwandaAnimation(EnemyAgwanda enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyAgwandaAnimation(EnemyAgwandaAnimationGroup.WALK);
