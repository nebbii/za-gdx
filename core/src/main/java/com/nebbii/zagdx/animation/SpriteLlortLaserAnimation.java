...
import com.nebbii.zagdx.SpriteLlortLaser;
import com.nebbii.zagdx.World;

public class SpriteLlortLaserAnimation extends GameAnimation {
    private final SpriteLlortLaser sprite;
    ...
    public SpriteLlortLaserAnimation(SpriteLlortLaser sprite) {
        super("idle");
        this.sprite = sprite;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getSpriteLlortLaser();
