...
import com.nebbii.zagdx.ImageLoader.NpcHorseAnimationGroup;
import com.nebbii.zagdx.NpcHorse;
import com.nebbii.zagdx.World;

public class NpcHorseAnimation extends GameAnimation {
    private final NpcHorse npc;
    ...
    public NpcHorseAnimation(NpcHorse npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcHorseAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcHorseAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcHorseAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcHorseAnimation(group);
