...
import com.nebbii.zagdx.ImageLoader.NpcDressyWomanAnimationGroup;
import com.nebbii.zagdx.NpcDressyWoman;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames, but only 3 sprite files exist on disk; using the real count
public class NpcDressyWomanAnimation extends GameAnimation {
    private final NpcDressyWoman npc;
    ...
    public NpcDressyWomanAnimation(NpcDressyWoman npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcDressyWomanAnimation(NpcDressyWomanAnimationGroup.IDLE);
