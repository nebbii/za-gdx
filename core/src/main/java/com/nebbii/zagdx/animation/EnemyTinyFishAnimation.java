...
import com.nebbii.zagdx.EnemyTinyFish;
import com.nebbii.zagdx.ImageLoader.EnemyTinyFishAnimationGroup;
...
public class EnemyTinyFishAnimation extends GameAnimation {
    private final EnemyTinyFish enemy;
    ...
    public EnemyTinyFishAnimation(EnemyTinyFish enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyTinyFish direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyTinyFishAnimation(EnemyTinyFishAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyTinyFishAnimation(EnemyTinyFishAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyTinyFishAnimation(EnemyTinyFishAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyTinyFishAnimation(EnemyTinyFishAnimationGroup.WALKLEFT);
