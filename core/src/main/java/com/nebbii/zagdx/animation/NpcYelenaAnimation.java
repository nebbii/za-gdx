...
import com.nebbii.zagdx.ImageLoader.NpcYelenaAnimationGroup;
import com.nebbii.zagdx.NpcYelena;
...
public class NpcYelenaAnimation extends GameAnimation {
    private final NpcYelena npc;
    ...
    public NpcYelenaAnimation(NpcYelena npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcYelenaAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcYelenaAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcYelenaAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcYelenaAnimation(group);
