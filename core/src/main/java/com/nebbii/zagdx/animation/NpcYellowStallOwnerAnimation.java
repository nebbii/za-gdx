...
import com.nebbii.zagdx.ImageLoader.NpcYellowStallOwnerAnimationGroup;
import com.nebbii.zagdx.NpcYellowStallOwner;
import com.nebbii.zagdx.World;

public class NpcYellowStallOwnerAnimation extends GameAnimation {
    private final NpcYellowStallOwner npc;
    ...
    public NpcYellowStallOwnerAnimation(NpcYellowStallOwner npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcYellowStallOwnerAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcYellowStallOwnerAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcYellowStallOwnerAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcYellowStallOwnerAnimation(group);
