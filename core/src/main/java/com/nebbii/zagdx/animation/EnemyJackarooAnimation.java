...
import com.nebbii.zagdx.EnemyJackaroo;
import com.nebbii.zagdx.ImageLoader.EnemyJackarooAnimationGroup;
...
public class EnemyJackarooAnimation extends GameAnimation {
    private final EnemyJackaroo enemy;
    ...
    public EnemyJackarooAnimation(EnemyJackaroo enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyJackaroo direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyJackarooAnimation(EnemyJackarooAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyJackarooAnimation(EnemyJackarooAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyJackarooAnimation(EnemyJackarooAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyJackarooAnimation(EnemyJackarooAnimationGroup.WALKLEFT);
