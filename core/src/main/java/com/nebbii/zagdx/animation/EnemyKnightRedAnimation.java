...
import com.nebbii.zagdx.EnemyKnightRed;
import com.nebbii.zagdx.ImageLoader.EnemyKnightRedAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 6/6/5/6 frames, but only 4 sprite files exist on disk for every group; using the 4 real frames
public class EnemyKnightRedAnimation extends GameAnimation {
    private final EnemyKnightRed enemy;
    ...
    public EnemyKnightRedAnimation(EnemyKnightRed enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyKnightRed direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyKnightRedAnimation(EnemyKnightRedAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyKnightRedAnimation(EnemyKnightRedAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyKnightRedAnimation(EnemyKnightRedAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyKnightRedAnimation(EnemyKnightRedAnimationGroup.WALKLEFT);
