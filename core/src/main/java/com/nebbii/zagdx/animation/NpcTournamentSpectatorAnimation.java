...
import com.nebbii.zagdx.ImageLoader.NpcTournamentSpectatorAnimationGroup;
import com.nebbii.zagdx.NpcTournamentSpectator;
import com.nebbii.zagdx.World;

public class NpcTournamentSpectatorAnimation extends GameAnimation {
    private final NpcTournamentSpectator npc;
    ...
    public NpcTournamentSpectatorAnimation(NpcTournamentSpectator npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcTournamentSpectatorAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcTournamentSpectatorAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcTournamentSpectatorAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcTournamentSpectatorAnimation(group);
