...
import com.nebbii.zagdx.ImageLoader.NpcThabulAnimationGroup;
import com.nebbii.zagdx.NpcThabul;
import com.nebbii.zagdx.World;

public class NpcThabulAnimation extends GameAnimation {
    private final NpcThabul npc;
    ...
    public NpcThabulAnimation(NpcThabul npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcThabulAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcThabulAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcThabulAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcThabulAnimation(group);
