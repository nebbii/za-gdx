...
import com.nebbii.zagdx.ImageLoader.NpcYvonneAnimationGroup;
import com.nebbii.zagdx.NpcYvonne;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames, but only 6 sprite files exist on disk; using the real
// count.
public class NpcYvonneAnimation extends GameAnimation {
    private final NpcYvonne npc;
    ...
    public NpcYvonneAnimation(NpcYvonne npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcYvonneAnimation(NpcYvonneAnimationGroup.IDLE);
