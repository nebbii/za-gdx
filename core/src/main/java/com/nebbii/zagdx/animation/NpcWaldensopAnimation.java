...
import com.nebbii.zagdx.ImageLoader.NpcWaldensopAnimationGroup;
import com.nebbii.zagdx.NpcWaldensop;
import com.nebbii.zagdx.World;

public class NpcWaldensopAnimation extends GameAnimation {
    private final NpcWaldensop npc;
    ...
    public NpcWaldensopAnimation(NpcWaldensop npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures =
            World.images.getNpcWaldensopAnimation(NpcWaldensopAnimationGroup.IDLE);
