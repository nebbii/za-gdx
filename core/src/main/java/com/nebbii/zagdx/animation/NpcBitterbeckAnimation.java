...
import com.nebbii.zagdx.ImageLoader.NpcBitterbeckAnimationGroup;
import com.nebbii.zagdx.NpcBitterbeck;
...
public class NpcBitterbeckAnimation extends GameAnimation {
    private final NpcBitterbeck npc;
    ...
    public NpcBitterbeckAnimation(NpcBitterbeck npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcBitterbeckAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcBitterbeckAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcBitterbeckAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcBitterbeckAnimation(group);
