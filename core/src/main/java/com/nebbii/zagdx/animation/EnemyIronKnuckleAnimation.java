...
import com.nebbii.zagdx.EnemyIronKnuckle;
import com.nebbii.zagdx.ImageLoader.EnemyIronKnuckleAnimationGroup;
...
public class EnemyIronKnuckleAnimation extends GameAnimation {
    private final EnemyIronKnuckle enemy;
    ...
    public EnemyIronKnuckleAnimation(EnemyIronKnuckle enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyIronKnuckle direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyIronKnuckleAnimation(EnemyIronKnuckleAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyIronKnuckleAnimation(EnemyIronKnuckleAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyIronKnuckleAnimation(EnemyIronKnuckleAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyIronKnuckleAnimation(EnemyIronKnuckleAnimationGroup.WALKLEFT);
