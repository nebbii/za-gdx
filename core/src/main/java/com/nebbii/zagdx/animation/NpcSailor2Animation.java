...
import com.nebbii.zagdx.ImageLoader.NpcSailor2AnimationGroup;
import com.nebbii.zagdx.NpcSailor2;
import com.nebbii.zagdx.World;

public class NpcSailor2Animation extends GameAnimation {
    private final NpcSailor2 npc;
    ...
    public NpcSailor2Animation(NpcSailor2 npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcSailor2AnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcSailor2AnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcSailor2AnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcSailor2AnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcSailor2Animation(group);
