...
import com.nebbii.zagdx.ImageLoader.NpcSirramBewAnimationGroup;
import com.nebbii.zagdx.NpcSirramBew;
import com.nebbii.zagdx.World;

public class NpcSirramBewAnimation extends GameAnimation {
    private final NpcSirramBew npc;
    ...
    public NpcSirramBewAnimation(NpcSirramBew npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcSirramBewAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcSirramBewAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcSirramBewAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcSirramBewAnimation(group);
