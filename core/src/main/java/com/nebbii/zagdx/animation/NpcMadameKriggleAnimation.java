...
import com.nebbii.zagdx.ImageLoader.NpcMadameKriggleAnimationGroup;
import com.nebbii.zagdx.NpcMadameKriggle;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames, but only 3 sprite files exist on disk; using the real count
public class NpcMadameKriggleAnimation extends GameAnimation {
    private final NpcMadameKriggle npc;
    ...
    public NpcMadameKriggleAnimation(NpcMadameKriggle npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcMadameKriggleAnimation(NpcMadameKriggleAnimationGroup.IDLE);
