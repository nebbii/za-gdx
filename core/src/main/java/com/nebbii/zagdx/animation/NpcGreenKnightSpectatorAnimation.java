...
import com.nebbii.zagdx.ImageLoader.NpcGreenKnightSpectatorAnimationGroup;
import com.nebbii.zagdx.NpcGreenKnightSpectator;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames per direction, but only 3 sprite files exist on disk per
...
public class NpcGreenKnightSpectatorAnimation extends GameAnimation {
    private final NpcGreenKnightSpectator npc;
    ...
    public NpcGreenKnightSpectatorAnimation(NpcGreenKnightSpectator npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcGreenKnightSpectator direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcGreenKnightSpectatorAnimation(NpcGreenKnightSpectatorAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcGreenKnightSpectatorAnimation(NpcGreenKnightSpectatorAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcGreenKnightSpectatorAnimation(NpcGreenKnightSpectatorAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcGreenKnightSpectatorAnimation(NpcGreenKnightSpectatorAnimationGroup.IDLELEFT);
