...
import com.nebbii.zagdx.ImageLoader.NpcYalzanAnimationGroup;
import com.nebbii.zagdx.NpcYalzan;
import com.nebbii.zagdx.World;

public class NpcYalzanAnimation extends GameAnimation {
    private final NpcYalzan npc;
    ...
    public NpcYalzanAnimation(NpcYalzan npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcYalzanAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcYalzanAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcYalzanAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcYalzanAnimation(group);
