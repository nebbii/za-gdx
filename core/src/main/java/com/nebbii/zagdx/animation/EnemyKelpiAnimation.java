...
import com.nebbii.zagdx.EnemyKelpi;
import com.nebbii.zagdx.ImageLoader.EnemyKelpiAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyKelpiAnimation extends GameAnimation {
    private final EnemyKelpi enemy;
    ...
    public EnemyKelpiAnimation(EnemyKelpi enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyKelpi direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyKelpiAnimation(EnemyKelpiAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyKelpiAnimation(EnemyKelpiAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyKelpiAnimation(EnemyKelpiAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyKelpiAnimation(EnemyKelpiAnimationGroup.WALKLEFT);
