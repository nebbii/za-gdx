...
import com.nebbii.zagdx.EnemyCactus;
import com.nebbii.zagdx.ImageLoader.EnemyCactusAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames, but only 3 sprite files exist on disk; using the 3 real frames
public class EnemyCactusAnimation extends GameAnimation {
    private final EnemyCactus enemy;
    ...
    public EnemyCactusAnimation(EnemyCactus enemy) {
        super("idle");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getEnemyCactusAnimation(EnemyCactusAnimationGroup.IDLE);
