...
import com.nebbii.zagdx.EnemySwampZolaBlue;
import com.nebbii.zagdx.ImageLoader.EnemySwampZolaBlueAnimationGroup;
...
public class EnemySwampZolaBlueAnimation extends GameAnimation {
    private final EnemySwampZolaBlue enemy;
    ...
    public EnemySwampZolaBlueAnimation(EnemySwampZolaBlue enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemySwampZolaBlue direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemySwampZolaBlueAnimation(EnemySwampZolaBlueAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemySwampZolaBlueAnimation(EnemySwampZolaBlueAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemySwampZolaBlueAnimation(EnemySwampZolaBlueAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemySwampZolaBlueAnimation(EnemySwampZolaBlueAnimationGroup.WALKLEFT);
