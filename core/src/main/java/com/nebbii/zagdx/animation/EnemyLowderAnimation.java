...
import com.nebbii.zagdx.EnemyLowder;
import com.nebbii.zagdx.ImageLoader.EnemyLowderAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 1 frame per direction, but 2 sprite files exist on disk; using the 2 real frames
public class EnemyLowderAnimation extends GameAnimation {
    private final EnemyLowder enemy;
    ...
    public EnemyLowderAnimation(EnemyLowder enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyLowder direction");
        }
