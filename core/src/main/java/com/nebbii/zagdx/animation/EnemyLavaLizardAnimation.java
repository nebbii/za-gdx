...
import com.nebbii.zagdx.EnemyLavaLizard;
import com.nebbii.zagdx.ImageLoader.EnemyLavaLizardAnimationGroup;
...
public class EnemyLavaLizardAnimation extends GameAnimation {
    private final EnemyLavaLizard enemy;
    ...
    public EnemyLavaLizardAnimation(EnemyLavaLizard enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyLavaLizard direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyLavaLizardAnimation(EnemyLavaLizardAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyLavaLizardAnimation(EnemyLavaLizardAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyLavaLizardAnimation(EnemyLavaLizardAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyLavaLizardAnimation(EnemyLavaLizardAnimationGroup.WALKLEFT);
