...
import com.nebbii.zagdx.EnemyCrockarock;
import com.nebbii.zagdx.ImageLoader.EnemyCrockarockAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames per direction, but only 3 sprite files exist on disk; using the 3 real frames
public class EnemyCrockarockAnimation extends GameAnimation {
    private final EnemyCrockarock enemy;
    ...
    public EnemyCrockarockAnimation(EnemyCrockarock enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyCrockarock direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyCrockarockAnimation(EnemyCrockarockAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyCrockarockAnimation(EnemyCrockarockAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyCrockarockAnimation(EnemyCrockarockAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyCrockarockAnimation(EnemyCrockarockAnimationGroup.WALKLEFT);
