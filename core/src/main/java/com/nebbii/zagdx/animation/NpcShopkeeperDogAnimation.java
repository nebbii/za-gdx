...
import com.nebbii.zagdx.ImageLoader.NpcShopkeeperDogAnimationGroup;
import com.nebbii.zagdx.NpcShopkeeperDog;
...
public class NpcShopkeeperDogAnimation extends GameAnimation {
    private final NpcShopkeeperDog npc;
    ...
    public NpcShopkeeperDogAnimation(NpcShopkeeperDog npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcShopkeeperDog direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcShopkeeperDogAnimation(NpcShopkeeperDogAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcShopkeeperDogAnimation(NpcShopkeeperDogAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcShopkeeperDogAnimation(NpcShopkeeperDogAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcShopkeeperDogAnimation(NpcShopkeeperDogAnimationGroup.IDLELEFT);
