...
import com.nebbii.zagdx.EnemyLeever;
import com.nebbii.zagdx.ImageLoader.EnemyLeeverAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyLeeverAnimation extends GameAnimation {
    private final EnemyLeever enemy;
    ...
    public EnemyLeeverAnimation(EnemyLeever enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyLeeverAnimation(EnemyLeeverAnimationGroup.WALK);
