...
import com.nebbii.zagdx.ImageLoader.NpcLodgeOwnerAnimationGroup;
import com.nebbii.zagdx.NpcLodgeOwner;
import com.nebbii.zagdx.World;

public class NpcLodgeOwnerAnimation extends GameAnimation {
    private final NpcLodgeOwner npc;
    ...
    public NpcLodgeOwnerAnimation(NpcLodgeOwner npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcLodgeOwnerAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcLodgeOwnerAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcLodgeOwnerAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcLodgeOwnerAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcLodgeOwnerAnimation(group);
