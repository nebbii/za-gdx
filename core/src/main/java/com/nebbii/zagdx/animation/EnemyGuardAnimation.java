...
import com.nebbii.zagdx.EnemyGuard;
import com.nebbii.zagdx.ImageLoader.EnemyGuardAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames for group0 (walk up), but only 5 sprite files exist on disk; using the 5 real frames
public class EnemyGuardAnimation extends GameAnimation {
    private final EnemyGuard enemy;
    ...
    public EnemyGuardAnimation(EnemyGuard enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyGuard direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyGuardAnimation(EnemyGuardAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyGuardAnimation(EnemyGuardAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyGuardAnimation(EnemyGuardAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyGuardAnimation(EnemyGuardAnimationGroup.WALKLEFT);
