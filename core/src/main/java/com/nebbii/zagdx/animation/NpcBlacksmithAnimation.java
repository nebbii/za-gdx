...
import com.nebbii.zagdx.ImageLoader.NpcBlacksmithAnimationGroup;
import com.nebbii.zagdx.NpcBlacksmith;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames per direction, but only 5 sprite files exist on disk per
...
public class NpcBlacksmithAnimation extends GameAnimation {
    private final NpcBlacksmith npc;
    ...
    public NpcBlacksmithAnimation(NpcBlacksmith npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcBlacksmith direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcBlacksmithAnimation(NpcBlacksmithAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcBlacksmithAnimation(NpcBlacksmithAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcBlacksmithAnimation(NpcBlacksmithAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcBlacksmithAnimation(NpcBlacksmithAnimationGroup.IDLELEFT);
