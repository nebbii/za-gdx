...
import com.nebbii.zagdx.ImageLoader.NpcFriendlyGoblinAnimationGroup;
import com.nebbii.zagdx.NpcFriendlyGoblin;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames, but only 5 sprite files exist on disk; using the real count
public class NpcFriendlyGoblinAnimation extends GameAnimation {
    private final NpcFriendlyGoblin npc;
    ...
    public NpcFriendlyGoblinAnimation(NpcFriendlyGoblin npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcFriendlyGoblinAnimation(NpcFriendlyGoblinAnimationGroup.IDLE);
