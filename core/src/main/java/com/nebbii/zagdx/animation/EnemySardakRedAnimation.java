...
import com.nebbii.zagdx.EnemySardakRed;
import com.nebbii.zagdx.ImageLoader.EnemySardakRedAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemySardakRedAnimation extends GameAnimation {
    private final EnemySardakRed enemy;
    ...
    public EnemySardakRedAnimation(EnemySardakRed enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled sardak red direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemySardakRedAnimation(EnemySardakRedAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemySardakRedAnimation(EnemySardakRedAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemySardakRedAnimation(EnemySardakRedAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemySardakRedAnimation(EnemySardakRedAnimationGroup.WALKLEFT);
