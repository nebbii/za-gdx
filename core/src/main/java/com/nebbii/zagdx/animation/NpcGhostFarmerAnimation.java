...
import com.nebbii.zagdx.ImageLoader.NpcGhostFarmerAnimationGroup;
import com.nebbii.zagdx.NpcGhostFarmer;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames, but only 3 sprite files exist on disk; using the real count
public class NpcGhostFarmerAnimation extends GameAnimation {
    private final NpcGhostFarmer npc;
    ...
    public NpcGhostFarmerAnimation(NpcGhostFarmer npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcGhostFarmerAnimation(NpcGhostFarmerAnimationGroup.IDLE);
