...
import com.nebbii.zagdx.ImageLoader.NpcPickpocketAnimationGroup;
import com.nebbii.zagdx.NpcPickpocket;
import com.nebbii.zagdx.World;

public class NpcPickpocketAnimation extends GameAnimation {
    private final NpcPickpocket npc;
    ...
    public NpcPickpocketAnimation(NpcPickpocket npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcPickpocketAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcPickpocketAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcPickpocketAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcPickpocketAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcPickpocketAnimation(group);
