...
import com.nebbii.zagdx.EnemyMimicMole;
import com.nebbii.zagdx.ImageLoader.EnemyMimicMoleAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 4 frames, but 5 sprite files exist on disk; using the 5 real frames
public class EnemyMimicMoleAnimation extends GameAnimation {
    private final EnemyMimicMole enemy;
    ...
    public EnemyMimicMoleAnimation(EnemyMimicMole enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyMimicMoleAnimation(EnemyMimicMoleAnimationGroup.WALK);
