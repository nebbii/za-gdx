...
import com.nebbii.zagdx.ImageLoader.NpcMerribalAnimationGroup;
import com.nebbii.zagdx.NpcMerribal;
import com.nebbii.zagdx.World;

public class NpcMerribalAnimation extends GameAnimation {
    private final NpcMerribal npc;
    ...
    public NpcMerribalAnimation(NpcMerribal npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcMerribalAnimation(NpcMerribalAnimationGroup.IDLE);
