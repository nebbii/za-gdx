...
import com.nebbii.zagdx.ImageLoader.NpcPurpleRavenAnimationGroup;
import com.nebbii.zagdx.NpcPurpleRaven;
import com.nebbii.zagdx.World;

public class NpcPurpleRavenAnimation extends GameAnimation {
    private final NpcPurpleRaven npc;
    ...
    public NpcPurpleRavenAnimation(NpcPurpleRaven npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcPurpleRavenAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcPurpleRavenAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcPurpleRavenAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcPurpleRavenAnimation(group);
