...
import com.nebbii.zagdx.ImageLoader.NpcTownMerchantAnimationGroup;
import com.nebbii.zagdx.NpcTownMerchant;
import com.nebbii.zagdx.World;

public class NpcTownMerchantAnimation extends GameAnimation {
    private final NpcTownMerchant npc;
    ...
    public NpcTownMerchantAnimation(NpcTownMerchant npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures =
            World.images.getNpcTownMerchantAnimation(NpcTownMerchantAnimationGroup.IDLE);
