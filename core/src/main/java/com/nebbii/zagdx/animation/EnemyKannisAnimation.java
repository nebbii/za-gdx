...
import com.nebbii.zagdx.EnemyKannis;
import com.nebbii.zagdx.ImageLoader.EnemyKannisAnimationGroup;
...
public class EnemyKannisAnimation extends GameAnimation {
    private final EnemyKannis enemy;
    ...
    public EnemyKannisAnimation(EnemyKannis enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyKannis direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyKannisAnimation(EnemyKannisAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyKannisAnimation(EnemyKannisAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyKannisAnimation(EnemyKannisAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyKannisAnimation(EnemyKannisAnimationGroup.WALKLEFT);
