...
import com.nebbii.zagdx.ImageLoader.NpcStrongmanAnimationGroup;
import com.nebbii.zagdx.NpcStrongman;
...
public class NpcStrongmanAnimation extends GameAnimation {
    private final NpcStrongman npc;
    ...
    public NpcStrongmanAnimation(NpcStrongman npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcStrongman direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcStrongmanAnimation(NpcStrongmanAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcStrongmanAnimation(NpcStrongmanAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcStrongmanAnimation(NpcStrongmanAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcStrongmanAnimation(NpcStrongmanAnimationGroup.IDLELEFT);
