...
import com.nebbii.zagdx.EnemyPurpleFish;
import com.nebbii.zagdx.ImageLoader.EnemyPurpleFishAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames per direction, but only 6 sprite files exist on disk; using the 6 real frames
public class EnemyPurpleFishAnimation extends GameAnimation {
    private final EnemyPurpleFish enemy;
    ...
    public EnemyPurpleFishAnimation(EnemyPurpleFish enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyPurpleFish direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyPurpleFishAnimation(EnemyPurpleFishAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyPurpleFishAnimation(EnemyPurpleFishAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyPurpleFishAnimation(EnemyPurpleFishAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyPurpleFishAnimation(EnemyPurpleFishAnimationGroup.WALKLEFT);
