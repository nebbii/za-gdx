...
import com.nebbii.zagdx.ImageLoader.NpcLoungerAnimationGroup;
import com.nebbii.zagdx.NpcLounger;
...
public class NpcLoungerAnimation extends GameAnimation {
    private final NpcLounger npc;
    ...
    public NpcLoungerAnimation(NpcLounger npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcLoungerAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcLoungerAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcLoungerAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcLoungerAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcLoungerAnimation(group);
