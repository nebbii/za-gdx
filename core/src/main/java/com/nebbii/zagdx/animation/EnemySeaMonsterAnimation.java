...
import com.nebbii.zagdx.EnemySeaMonster;
import com.nebbii.zagdx.ImageLoader.EnemySeaMonsterAnimationGroup;
...
public class EnemySeaMonsterAnimation extends GameAnimation {
    private final EnemySeaMonster enemy;
    ...
    public EnemySeaMonsterAnimation(EnemySeaMonster enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemySeaMonster direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemySeaMonsterAnimation(EnemySeaMonsterAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemySeaMonsterAnimation(EnemySeaMonsterAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemySeaMonsterAnimation(EnemySeaMonsterAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemySeaMonsterAnimation(EnemySeaMonsterAnimationGroup.WALKLEFT);
