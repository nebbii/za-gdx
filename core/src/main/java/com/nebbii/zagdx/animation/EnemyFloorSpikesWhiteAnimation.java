...
import com.nebbii.zagdx.EnemyFloorSpikesWhite;
import com.nebbii.zagdx.ImageLoader.EnemyFloorSpikesWhiteAnimationGroup;
...
public class EnemyFloorSpikesWhiteAnimation extends GameAnimation {
    private final EnemyFloorSpikesWhite enemy;
    ...
    public EnemyFloorSpikesWhiteAnimation(EnemyFloorSpikesWhite enemy) {
        super("idle");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getEnemyFloorSpikesWhiteAnimation(EnemyFloorSpikesWhiteAnimationGroup.IDLE);
