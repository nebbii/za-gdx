...
import com.nebbii.zagdx.EnemyDragonfly;
import com.nebbii.zagdx.ImageLoader.EnemyDragonflyAnimationGroup;
...
public class EnemyDragonflyAnimation extends GameAnimation {
    private final EnemyDragonfly enemy;
    ...
    public EnemyDragonflyAnimation(EnemyDragonfly enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyDragonfly direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyDragonflyAnimation(EnemyDragonflyAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyDragonflyAnimation(EnemyDragonflyAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyDragonflyAnimation(EnemyDragonflyAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyDragonflyAnimation(EnemyDragonflyAnimationGroup.WALKLEFT);
