...
import com.nebbii.zagdx.ImageLoader.NpcRycoAnimationGroup;
import com.nebbii.zagdx.NpcRyco;
import com.nebbii.zagdx.World;

public class NpcRycoAnimation extends GameAnimation {
    private final NpcRyco npc;
    ...
    public NpcRycoAnimation(NpcRyco npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcRycoAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcRycoAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcRycoAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcRycoAnimation(group);
