...
import com.nebbii.zagdx.EnemyRope;
import com.nebbii.zagdx.ImageLoader.EnemyRopeAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 5/5/4/5 frames for up/right/down/left, but 6/6/4/6 sprite files
// exist on disk; using the real counts (down keeps its 4 frames)
public class EnemyRopeAnimation extends GameAnimation {
    private final EnemyRope enemy;
    ...
    public EnemyRopeAnimation(EnemyRope enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyRope direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyRopeAnimation(EnemyRopeAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyRopeAnimation(EnemyRopeAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyRopeAnimation(EnemyRopeAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyRopeAnimation(EnemyRopeAnimationGroup.WALKLEFT);
