...
import com.nebbii.zagdx.EnemyGanonFairy;
import com.nebbii.zagdx.ImageLoader.EnemyGanonFairyAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyGanonFairyAnimation extends GameAnimation {
    private final EnemyGanonFairy enemy;
    ...
    public EnemyGanonFairyAnimation(EnemyGanonFairy enemy) {
        super("idle");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getEnemyGanonFairyAnimation(EnemyGanonFairyAnimationGroup.IDLE);
