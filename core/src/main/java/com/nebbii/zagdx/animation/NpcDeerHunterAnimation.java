...
import com.nebbii.zagdx.ImageLoader.NpcDeerHunterAnimationGroup;
import com.nebbii.zagdx.NpcDeerHunter;
import com.nebbii.zagdx.World;

public class NpcDeerHunterAnimation extends GameAnimation {
    private final NpcDeerHunter npc;
    ...
    public NpcDeerHunterAnimation(NpcDeerHunter npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcDeerHunterAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcDeerHunterAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcDeerHunterAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcDeerHunterAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcDeerHunterAnimation(group);
