...
import com.nebbii.zagdx.EnemyPurpleBird;
import com.nebbii.zagdx.ImageLoader.EnemyPurpleBirdAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyPurpleBirdAnimation extends GameAnimation {
    private final EnemyPurpleBird enemy;
    ...
    public EnemyPurpleBirdAnimation(EnemyPurpleBird enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyPurpleBird direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyPurpleBirdAnimation(EnemyPurpleBirdAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyPurpleBirdAnimation(EnemyPurpleBirdAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyPurpleBirdAnimation(EnemyPurpleBirdAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyPurpleBirdAnimation(EnemyPurpleBirdAnimationGroup.WALKLEFT);
