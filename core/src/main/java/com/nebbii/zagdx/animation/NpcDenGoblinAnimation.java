...
import com.nebbii.zagdx.ImageLoader.NpcDenGoblinAnimationGroup;
import com.nebbii.zagdx.NpcDenGoblin;
...
public class NpcDenGoblinAnimation extends GameAnimation {
    private final NpcDenGoblin npc;
    ...
    public NpcDenGoblinAnimation(NpcDenGoblin npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcDenGoblin direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcDenGoblinAnimation(NpcDenGoblinAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcDenGoblinAnimation(NpcDenGoblinAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcDenGoblinAnimation(NpcDenGoblinAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcDenGoblinAnimation(NpcDenGoblinAnimationGroup.IDLELEFT);
