...
import com.nebbii.zagdx.ImageLoader.NpcKronThePeglegAnimationGroup;
import com.nebbii.zagdx.NpcKronThePegleg;
...
public class NpcKronThePeglegAnimation extends GameAnimation {
    private final NpcKronThePegleg npc;
    ...
    public NpcKronThePeglegAnimation(NpcKronThePegleg npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcKronThePeglegAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcKronThePeglegAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcKronThePeglegAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcKronThePeglegAnimation(group);
