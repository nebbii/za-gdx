...
import com.nebbii.zagdx.EnemyCrystalShard;
import com.nebbii.zagdx.ImageLoader.EnemyCrystalShardAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyCrystalShardAnimation extends GameAnimation {
    private final EnemyCrystalShard enemy;
    ...
    public EnemyCrystalShardAnimation(EnemyCrystalShard enemy) {
        super("idle");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getEnemyCrystalShardAnimation(EnemyCrystalShardAnimationGroup.IDLE);
