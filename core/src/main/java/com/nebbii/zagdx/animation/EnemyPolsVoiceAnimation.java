...
import com.nebbii.zagdx.EnemyPolsVoice;
import com.nebbii.zagdx.ImageLoader.EnemyPolsVoiceAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyPolsVoiceAnimation extends GameAnimation {
    private final EnemyPolsVoice enemy;
    ...
    public EnemyPolsVoiceAnimation(EnemyPolsVoice enemy) {
        super("walk");
        this.enemy = enemy;
    ...
    private Animation<TextureRegion> initWalk() {
        Texture[] textures = World.images.getEnemyPolsVoiceAnimation(EnemyPolsVoiceAnimationGroup.WALK);
