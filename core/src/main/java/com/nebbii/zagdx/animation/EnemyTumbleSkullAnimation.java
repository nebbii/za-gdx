...
import com.nebbii.zagdx.EnemyTumbleSkull;
import com.nebbii.zagdx.ImageLoader.EnemyTumbleSkullAnimationGroup;
...
public class EnemyTumbleSkullAnimation extends GameAnimation {
    private final EnemyTumbleSkull enemy;
    ...
    public EnemyTumbleSkullAnimation(EnemyTumbleSkull enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyTumbleSkull direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyTumbleSkullAnimation(EnemyTumbleSkullAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyTumbleSkullAnimation(EnemyTumbleSkullAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyTumbleSkullAnimation(EnemyTumbleSkullAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyTumbleSkullAnimation(EnemyTumbleSkullAnimationGroup.WALKLEFT);
