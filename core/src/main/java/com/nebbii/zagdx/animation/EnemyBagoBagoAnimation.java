...
import com.nebbii.zagdx.EnemyBagoBago;
import com.nebbii.zagdx.ImageLoader.EnemyBagoBagoAnimationGroup;
...
public class EnemyBagoBagoAnimation extends GameAnimation {
    private final EnemyBagoBago enemy;
    ...
    public EnemyBagoBagoAnimation(EnemyBagoBago enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyBagoBago direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyBagoBagoAnimation(EnemyBagoBagoAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyBagoBagoAnimation(EnemyBagoBagoAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyBagoBagoAnimation(EnemyBagoBagoAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyBagoBagoAnimation(EnemyBagoBagoAnimationGroup.WALKLEFT);
