...
import com.nebbii.zagdx.ImageLoader.NpcForeignWomanAnimationGroup;
import com.nebbii.zagdx.NpcForeignWoman;
import com.nebbii.zagdx.World;

public class NpcForeignWomanAnimation extends GameAnimation {
    private final NpcForeignWoman npc;
    ...
    public NpcForeignWomanAnimation(NpcForeignWoman npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcForeignWomanAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcForeignWomanAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcForeignWomanAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcForeignWomanAnimation(group);
