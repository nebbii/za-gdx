...
import com.nebbii.zagdx.ImageLoader.NpcRebelRightAnimationGroup;
import com.nebbii.zagdx.NpcRebelRight;
import com.nebbii.zagdx.World;

public class NpcRebelRightAnimation extends GameAnimation {
    private final NpcRebelRight npc;
    ...
    public NpcRebelRightAnimation(NpcRebelRight npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcRebelRightAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcRebelRightAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcRebelRightAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcRebelRightAnimation(group);
