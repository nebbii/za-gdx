...
import com.nebbii.zagdx.ImageLoader.NpcDockhandAnimationGroup;
import com.nebbii.zagdx.NpcDockhand;
import com.nebbii.zagdx.World;

public class NpcDockhandAnimation extends GameAnimation {
    private final NpcDockhand npc;
    ...
    public NpcDockhandAnimation(NpcDockhand npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcDockhandAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcDockhandAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcDockhandAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcDockhandAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcDockhandAnimation(group);
