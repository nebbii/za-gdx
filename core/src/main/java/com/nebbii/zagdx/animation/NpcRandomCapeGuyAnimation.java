...
import com.nebbii.zagdx.ImageLoader.NpcRandomCapeGuyAnimationGroup;
import com.nebbii.zagdx.NpcRandomCapeGuy;
...
public class NpcRandomCapeGuyAnimation extends GameAnimation {
    private final NpcRandomCapeGuy npc;
    ...
    public NpcRandomCapeGuyAnimation(NpcRandomCapeGuy npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcRandomCapeGuy direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcRandomCapeGuyAnimation(NpcRandomCapeGuyAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcRandomCapeGuyAnimation(NpcRandomCapeGuyAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcRandomCapeGuyAnimation(NpcRandomCapeGuyAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcRandomCapeGuyAnimation(NpcRandomCapeGuyAnimationGroup.IDLELEFT);
