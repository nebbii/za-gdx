...
import com.nebbii.zagdx.ImageLoader.NpcKrebbAnimationGroup;
import com.nebbii.zagdx.NpcKrebb;
import com.nebbii.zagdx.World;

public class NpcKrebbAnimation extends GameAnimation {
    private final NpcKrebb npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcKrebbAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcKrebbAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcKrebbAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcKrebbAnimation(group);
