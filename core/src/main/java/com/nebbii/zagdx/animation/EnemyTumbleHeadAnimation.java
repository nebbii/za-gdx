...
import com.nebbii.zagdx.EnemyTumbleHead;
import com.nebbii.zagdx.ImageLoader.EnemyTumbleHeadAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyTumbleHeadAnimation extends GameAnimation {
    private final EnemyTumbleHead enemy;
    ...
    public EnemyTumbleHeadAnimation(EnemyTumbleHead enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyTumbleHead direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyTumbleHeadAnimation(EnemyTumbleHeadAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyTumbleHeadAnimation(EnemyTumbleHeadAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyTumbleHeadAnimation(EnemyTumbleHeadAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyTumbleHeadAnimation(EnemyTumbleHeadAnimationGroup.WALKLEFT);
