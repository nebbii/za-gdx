...
import com.nebbii.zagdx.ImageLoader.NpcGhostDogAnimationGroup;
import com.nebbii.zagdx.NpcGhostDog;
...
public class NpcGhostDogAnimation extends GameAnimation {
    private final NpcGhostDog npc;
    ...
    public NpcGhostDogAnimation(NpcGhostDog npc) {
        super("idleDown");
        this.npc = npc;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (npc.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled NpcGhostDog direction");
        }
    ...
    private Animation<TextureRegion> initIdleUp() {
        Texture[] textures = World.images.getNpcGhostDogAnimation(NpcGhostDogAnimationGroup.IDLEUP);
    ...
    private Animation<TextureRegion> initIdleRight() {
        Texture[] textures = World.images.getNpcGhostDogAnimation(NpcGhostDogAnimationGroup.IDLERIGHT);
    ...
    private Animation<TextureRegion> initIdleDown() {
        Texture[] textures = World.images.getNpcGhostDogAnimation(NpcGhostDogAnimationGroup.IDLEDOWN);
    ...
    private Animation<TextureRegion> initIdleLeft() {
        Texture[] textures = World.images.getNpcGhostDogAnimation(NpcGhostDogAnimationGroup.IDLELEFT);
