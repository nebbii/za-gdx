...
import com.nebbii.zagdx.EnemyTurtle;
import com.nebbii.zagdx.ImageLoader.EnemyTurtleAnimationGroup;
...
public class EnemyTurtleAnimation extends GameAnimation {
    private final EnemyTurtle enemy;
    ...
    public EnemyTurtleAnimation(EnemyTurtle enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyTurtle direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyTurtleAnimation(EnemyTurtleAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyTurtleAnimation(EnemyTurtleAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyTurtleAnimation(EnemyTurtleAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyTurtleAnimation(EnemyTurtleAnimationGroup.WALKLEFT);
