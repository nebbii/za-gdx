...
import com.nebbii.zagdx.ImageLoader.NpcSleepingManAnimationGroup;
import com.nebbii.zagdx.NpcSleepingMan;
import com.nebbii.zagdx.World;

public class NpcSleepingManAnimation extends GameAnimation {
    private final NpcSleepingMan npc;
    ...
    public NpcSleepingManAnimation(NpcSleepingMan npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcSleepingManAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcSleepingManAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcSleepingManAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcSleepingManAnimation(group);
