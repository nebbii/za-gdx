...
import com.nebbii.zagdx.ImageLoader.NpcQuarryMinerAnimationGroup;
import com.nebbii.zagdx.NpcQuarryMiner;
import com.nebbii.zagdx.World;

public class NpcQuarryMinerAnimation extends GameAnimation {
    private final NpcQuarryMiner npc;
    ...
    public NpcQuarryMinerAnimation(NpcQuarryMiner npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcQuarryMinerAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcQuarryMinerAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcQuarryMinerAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcQuarryMinerAnimation(group);
