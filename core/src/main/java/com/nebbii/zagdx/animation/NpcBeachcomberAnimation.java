...
import com.nebbii.zagdx.ImageLoader.NpcBeachcomberAnimationGroup;
import com.nebbii.zagdx.NpcBeachcomber;
...
public class NpcBeachcomberAnimation extends GameAnimation {
    private final NpcBeachcomber npc;
    ...
    public NpcBeachcomberAnimation(NpcBeachcomber npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcBeachcomberAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcBeachcomberAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle2() {
        ...
        return initIdle(NpcBeachcomberAnimationGroup.IDLE2, frameData, idle2OffsetX, idle2OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcBeachcomberAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcBeachcomberAnimation(group);
