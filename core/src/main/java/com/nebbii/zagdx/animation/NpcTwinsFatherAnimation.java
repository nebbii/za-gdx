...
import com.nebbii.zagdx.ImageLoader.NpcTwinsFatherAnimationGroup;
import com.nebbii.zagdx.NpcTwinsFather;
import com.nebbii.zagdx.World;

public class NpcTwinsFatherAnimation extends GameAnimation {
    private final NpcTwinsFather npc;
    ...
    public NpcTwinsFatherAnimation(NpcTwinsFather npc) {
        super("idle");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcTwinsFatherAnimation(NpcTwinsFatherAnimationGroup.IDLE);
