...
import com.nebbii.zagdx.ImageLoader.NpcBrideAnimationGroup;
import com.nebbii.zagdx.NpcBride;
import com.nebbii.zagdx.World;

public class NpcBrideAnimation extends GameAnimation {
    private final NpcBride npc;
    ...
    public NpcBrideAnimation(NpcBride npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcBrideAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcBrideAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcBrideAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcBrideAnimation(group);
