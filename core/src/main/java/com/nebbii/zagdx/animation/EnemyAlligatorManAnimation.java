...
import com.nebbii.zagdx.EnemyAlligatorMan;
import com.nebbii.zagdx.ImageLoader.EnemyAlligatorManAnimationGroup;
import com.nebbii.zagdx.World;

public class EnemyAlligatorManAnimation extends GameAnimation {
    private final EnemyAlligatorMan enemy;
    ...
    public EnemyAlligatorManAnimation(EnemyAlligatorMan enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyAlligatorMan direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyAlligatorManAnimation(EnemyAlligatorManAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyAlligatorManAnimation(EnemyAlligatorManAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyAlligatorManAnimation(EnemyAlligatorManAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyAlligatorManAnimation(EnemyAlligatorManAnimationGroup.WALKLEFT);
