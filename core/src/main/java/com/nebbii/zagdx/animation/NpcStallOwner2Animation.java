...
import com.nebbii.zagdx.ImageLoader.NpcStallOwner2AnimationGroup;
import com.nebbii.zagdx.NpcStallOwner2;
import com.nebbii.zagdx.World;

public class NpcStallOwner2Animation extends GameAnimation {
    private final NpcStallOwner2 npc;
    ...
    public NpcStallOwner2Animation(NpcStallOwner2 npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcStallOwner2AnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcStallOwner2AnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcStallOwner2AnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcStallOwner2Animation(group);
