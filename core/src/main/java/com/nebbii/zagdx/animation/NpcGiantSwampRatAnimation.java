...
import com.nebbii.zagdx.ImageLoader.NpcGiantSwampRatAnimationGroup;
import com.nebbii.zagdx.NpcGiantSwampRat;
...
public class NpcGiantSwampRatAnimation extends GameAnimation {
    private final NpcGiantSwampRat npc;
    ...
    public NpcGiantSwampRatAnimation(NpcGiantSwampRat npc) {
        super("idle0");
        this.npc = npc;
    ...
    private Animation<TextureRegion> initIdle0() {
        ...
        return initIdle(NpcGiantSwampRatAnimationGroup.IDLE0, frameData, idle0OffsetX, idle0OffsetY);
    }
    ...
    private Animation<TextureRegion> initIdle1() {
        ...
        return initIdle(NpcGiantSwampRatAnimationGroup.IDLE1, frameData, idle1OffsetX, idle1OffsetY);
    }

    private Animation<TextureRegion> initIdle(
        NpcGiantSwampRatAnimationGroup group,
        int[][] frameData,
        int[] animationOffsetX,
        int[] animationOffsetY
    ) {
        Texture[] textures = World.images.getNpcGiantSwampRatAnimation(group);
