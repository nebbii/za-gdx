...
import com.nebbii.zagdx.EnemyBolla;
import com.nebbii.zagdx.ImageLoader.EnemyBollaAnimationGroup;
import com.nebbii.zagdx.World;

// TODO: extractor reported 8 frames for WALKUP, but only 5 sprite files exist on disk (matching the other 3 directions); using 5 for all directions
public class EnemyBollaAnimation extends GameAnimation {
    private final EnemyBolla enemy;
    ...
    public EnemyBollaAnimation(EnemyBolla enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemyBolla direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemyBollaAnimation(EnemyBollaAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemyBollaAnimation(EnemyBollaAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemyBollaAnimation(EnemyBollaAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemyBollaAnimation(EnemyBollaAnimationGroup.WALKLEFT);
