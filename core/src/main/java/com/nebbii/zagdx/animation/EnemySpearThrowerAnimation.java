...
import com.nebbii.zagdx.EnemySpearThrower;
import com.nebbii.zagdx.ImageLoader.EnemySpearThrowerAnimationGroup;
...
public class EnemySpearThrowerAnimation extends GameAnimation {
    private final EnemySpearThrower enemy;
    ...
    public EnemySpearThrowerAnimation(EnemySpearThrower enemy) {
        super("walkDown");
        this.enemy = enemy;
    ...
    public TextureRegion playCurrentAnimation() {
        ...
        switch (enemy.getDirection()) {
            ...
            case LEFT:
                ...
                break;
            default:
                throw new IllegalStateException("Unhandled EnemySpearThrower direction");
        }
    ...
    private Animation<TextureRegion> initWalkUp() {
        Texture[] textures = World.images.getEnemySpearThrowerAnimation(EnemySpearThrowerAnimationGroup.WALKUP);
    ...
    private Animation<TextureRegion> initWalkRight() {
        Texture[] textures = World.images.getEnemySpearThrowerAnimation(EnemySpearThrowerAnimationGroup.WALKRIGHT);
    ...
    private Animation<TextureRegion> initWalkDown() {
        Texture[] textures = World.images.getEnemySpearThrowerAnimation(EnemySpearThrowerAnimationGroup.WALKDOWN);
    ...
    private Animation<TextureRegion> initWalkLeft() {
        Texture[] textures = World.images.getEnemySpearThrowerAnimation(EnemySpearThrowerAnimationGroup.WALKLEFT);
