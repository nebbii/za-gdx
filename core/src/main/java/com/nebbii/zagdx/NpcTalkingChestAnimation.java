...
import com.nebbii.zagdx.ImageLoader.NpcTalkingChestAnimationGroup;
import com.nebbii.zagdx.NpcTalkingChest;
import com.nebbii.zagdx.World;

public class NpcTalkingChestAnimation extends GameAnimation {
    private final NpcTalkingChest npc;
    ...
    public NpcTalkingChestAnimation(NpcTalkingChest npc) {
        super("idle");
        this.npc = npc;
    ...
    public Animation<TextureRegion> initIdle() {
        Texture[] textures = World.images.getNpcTalkingChestAnimation(NpcTalkingChestAnimationGroup.IDLE);
