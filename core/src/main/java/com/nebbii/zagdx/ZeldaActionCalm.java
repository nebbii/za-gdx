...
import com.nebbii.zagdx.animation.FriendlyCalmAnimation;

public class ZeldaActionCalm extends ZeldaAction {
    private final Rectangle hitbox;
    private FriendlyCalmAnimation animation;
    private float speed;

    public ZeldaActionCalm(Actor actor, float x, float y) {
        super(actor, x, y);
    ...
    public void draw(SpriteBatch batch) {
        if (animation == null) {
            animation = new FriendlyCalmAnimation();
        }
